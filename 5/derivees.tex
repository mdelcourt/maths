...
\begin{remark}
    ...
    Dans le cas où $f$ est dérivable en $a$, le nombre dérivé de $f$ en $a$ est la pente de la tangente de $f$ en $a$.
    
    Sur le graphique suivant, on voit que $f$ est dérivable partout sauf en $0$.
