...
\begin{proof}
    ...
    \begin{multicols}{2}
        ...
        les sécantes par la \emph{gauche} sont tournées vers le \emph{haut}
        \begin{plot}{0.3}{-6}{-3}{6}{6}
            \def\f{-1/5*(\x)^2 + 2}
            \plotfunction{-6:6}{\f}
            \drawsecant{\f}{-1}{0}{-4:3}
            \showxcoordinates{\f}{-1}{[below] {$x$}}
        \end{plot}
        ...
        Si $x$ est \emph{suffisamment proche} de $a$ avec $x > a$,
        alors on en déduit que
        les sécantes par la \emph{droite} sont tournées vers le \emph{bas}
        \begin{plot}{0.3}{-6}{-3}{6}{6}
            \def\f{-1/5*(\x)^2 + 2}
            \plotfunction{-6:6}{\f}
        ...
        \end{align}
        En faisant tendre $x$ vers $a$, on obtientd
        \begin{align}
            f'(a) \le 0.
        \end{align}
    \end{multicols}
...
\begin{example}
    ...
    \begin{plot}{0.5}{-5}{-5}{5}{5}
        \def\f{(\x)^5 - (10/3)*(\x)^3}
        \plotfunction{-5:5}{\f}
        \showxcoordinates{\f}{-1}{[below] {$-1$}}
        \showxcoordinates{\f}{1}{[above] {$1$}}
        \drawpoint[black]{0, 0}
    \end{plot}
\end{example}
