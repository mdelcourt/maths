...
\begin{definition}
    ...
    lorsque \emph{$x$ est suffisament proche de $a$ avec $x \in I$ et $x \geq a$}.
\end{definition}
...
\begin{definition}
    ...
    \end{align}
    si \emph{$f(x)$ est aussi proche que l'on veut de $L$}
    lorsque \emph{$x$ est suffisament grand avec $x \in I$}.
\end{definition}
...
\begin{figure}
    ...
    \begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=0.5cm,y=0.5cm]
        \draw [color=cqcqcq,xstep=0.5cm,ystep=0.5cm] (-3.,-4.) grid (9.,8.);
        \draw[->,color=black] (-3.,0.) -- (9.,0.);
        \draw[->,color=black] (0.,-4.) -- (0.,8.);
        \clip(-3.,-4.) rectangle (9.,8.);
        \draw[line width=1.2pt,smooth,samples=200,domain=-3.0:9.0] plot(\x,{1.0/((\x)-3.0)+2.0});
        \draw [line width=1.2pt] (3.,-4.) -- (3.,8.);
        \draw [line width=1.2pt,domain=-3.:9.] plot(\x,{(--2.-0.*\x)/1.});
    \end{tikzpicture}
