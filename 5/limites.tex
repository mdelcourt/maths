...
\begin{enumerate}
    ...
    \item Si $n(a) \neq 0$ mais $d(a) = 0$,
        ...
        (voir sous-section~\ref{subsubsection:indetermination_k_sur_0}).
    \item Si $n(a) = d(a) = 0$,
...
\subsubsection{Indétermination $k$ sur $0$}\label{subsubsection:indetermination_k_sur_0}

Nous sommes dans le cas où $n(a) \neq 0$ mais $d(a) = 0$.
...
\begin{example}
    ...
    \begin{align}
        \lim_{x \to 1} \frac {x^3 - 7x - 6} {x^2 + x - 2}.
    \end{align}
    ...
    Le tableau de signe
    \signtable{$x$/0.75, $-12$/0.75, $x^2 + x - 2$/0.75, $\frac {-12} {x^2 + x - 2}$/0.75}{,$1$, $2$,}{%
        \signrow{,-,-,-,-,-,}
        \signrow{,+,0,-,0,+,}
        \signrow{,-,d,+,d,-,}
    }
    ...
    \begin{align}
        \lim_{x \to 1^-} \frac {x^3 - 7x - 6} {x^2 + x - 2} &= -\infty,\\
        \lim_{x \to 1^+} \frac {x^3 - 7x - 6} {x^2 + x - 2} &= +\infty,
    \end{align}
\end{example}
