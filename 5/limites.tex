...
mais devient de plus en plus précise
...
C'est en effet pour cette raison que les nombres réels sont introduits. % Référence?
De même,
une volonté d'obtenir des limites plus esthétiques est un des facteurs a conduit à l'abandon du degré comme mesure d'angle privilégiée au profit du radian (voir \href{https://en.wikipedia.org/wiki/Radian#Advantages_of_measuring_in_radians}{ici} pour plus de détails).
...
Les bornes d'un intervalle $I$ non vide sont appelées respectivement \emph{infimum} et \emph{supremum} de cet interval.
Par exemple, l'infimum de $]3, 5]$ est $3$ et le supremum est $5$.
L'infimum et le supremum d'un intervalle $I$ sont notés respectivement $\inf I$ et $\sup I$.
